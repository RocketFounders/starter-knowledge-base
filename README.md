...
- **registry.py**: Регистрация различных компонентов приложения.
...
[Подключение к БД из PyCharm/WebStorm через утилиту DataGrip](https://www.jetbrains.com/help/pycharm/connecting-to-a-database.html)
